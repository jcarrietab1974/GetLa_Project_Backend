const Productos = require("../../models/Productos/aseo");

// Obtener todos los productos de repuestos
exports.obtenerProductosAseoHome = async (req, res) => {
  try {
...
exports.crearProductosAseo = async (req, res) => {
  const {
    referencia,
    nombre,
    descripcion,
...
exports.actualizarProductosAseo = async (req, res) => {
  const { id } = req.params;
...
exports.borrarProductosAseo = async (req, res) => {
  try {
